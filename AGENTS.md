...
5. Tool names use `snake_case`: `get_open_incidents`, `get_incident_by_id`, `get_service_health`.
...
6. Click **"🏗️ Explain Architecture"** in the sidebar to show the flow diagram
